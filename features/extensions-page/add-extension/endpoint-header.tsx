...
export const EndpointHeaderTitle = () => {
  return (
    <div className="flex gap-2">
      <Label className="flex-1 text-muted-foreground">Key</Label>
      <Label className="flex-1 text-muted-foreground">Value</Label>
      <Label className="w-10 text-muted-foreground"> </Label>
    </div>
  );
};
...
export const EndpointHeader = () => {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-md border bg-foreground/[0.02] p-4">
