...
import { AddOrUpdateExtension, extensionStore, useExtensionState } from '../extension-store';
...
export const AddExtension: FC<Props> = (props) => {
  ...
  const [formState, formAction] = useFormState(AddOrUpdateExtension, initialState);
  ...
  return (
    ...
    >
      <SheetContent className="flex min-w-[680px] flex-col">
        <SheetHeader>
          <SheetTitle>Extension</SheetTitle>
        </SheetHeader>
        <form action={formAction} className="flex flex-1 flex-col">
          <ScrollArea className="-mx-6 h-full max-h-[calc(100vh-140px)]" type="always">
